...
<section class="about__main main">
    ...
    <div class="about__content">
        ...
        <div class="homepage__button">
            ...
            <button><a class="button__linkTransparent" href="../pages/projects.php">My Work</a></button>
        </div>
    </div>
</section>
...
<section id="skills">
    ...
    <div class="skill-category">
        ...
        <ul>
            <li>HTML5, CSS, JavaScript, TypeScript, PHP, Bootstrap</li>
    ...
    <div class="skill-category">
        ...
        <ul>
            <li>Laravel, React, TypeScript, Tailwind, Bootstrap</li>
        </ul>
    </div>
...
<section class="about__downloads">
    ...
    <table>
        ...
        <tr>
            ...
            <td class="align-right"><a target="_blank" href="../assets/docs/Arbeitszeugnis, Zertifikate, Diplome Kim Spiering.pdf"><img class="download__img" src="/assets/images/download.png" alt="download image"></a></td>
        </tr>
